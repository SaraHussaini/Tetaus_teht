...
# 🧪 Tehtävä 9 – Oman taustapalvelimen (API) testaus

Tässä tehtävässä testataan oman Node.js-taustapalvelimen REST API -rajapintaa käyttäen Robot Frameworkia ja RequestsLibrarya.
...
-  Merkintöjen hakeminen

## 📁 Testitiedosto
Testikoodi on tallennettu tiedostoon:
``` bash
tests/server_api_test.robot
```
### 💻 Testikoodi
``` bash
*** Settings ***
